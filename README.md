...
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------- | --------------------------------------------------------------------------------------------------- |
| 🗺️ **Map Stack**            | Esri satellite imagery, Google Photorealistic 3D, OSM, NASA Daily (yesterday's VIIRS true colour), plus additional ion-hosted stacks                                                                                                                                                                                                                                                                                            | Esri / Google / Ion / OSM               | 🟢 Esri satellite + OSM · 🟡 ion-hosted Google 3D + world terrain · 🔴 direct Google + place search |
...
| 🔥 **Amazon Fires (INPE)**  | Live INPE Programa Queimadas detections over the Amazon biome (all satellites), trailing 24h — keyless open data                                                                                                                                                                                                                                                                | INPE Queimadas                          | 🟢                                                                                                  |
| ◩ **DETER Alerts (INPE)**   | INPE DETER deforestation, degradation, mining and burn-scar alert polygons over the Amazon biome, trailing 30 days — keyless open data                                                                                                                                                                                                                                        | INPE DETER / TerraBrasilis              | 🟢                                                                                                  |
| ≈ **River Gauges (ANA)**    | Live river level at the Amazon trunk gauges (Manaus, Manacapuru, Itacoatiara, Óbidos…): 15-minute telemetry, 24h trend and 48h sparkline — keyless open data                                                                                                                                                                                                                | ANA / SNIRH                             | 🟢                                                                                                  |
| ⬡ **Airspace (DECEA)**      | Brazilian controlled airspace (TMA, CTR, ATZ) and prohibited/restricted/danger areas extruded between their real vertical limits, plus aerodromes and heliports, from the DECEA GeoAISWEB WFS — keyless; informational, not for navigation                                                                                                                                | DECEA / ICA GeoAISWEB                   | 🟢                                                                                                  |
